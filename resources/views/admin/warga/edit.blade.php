...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-slate-900">Edit Data Warga</h1>
            <p class="text-xs text-slate-500 mt-0.5">Perbarui informasi kependudukan {{ $warga->nama_lengkap }}.</p>
        </div>
    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
        <form action="{{ route('admin.warga.update', $warga) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
