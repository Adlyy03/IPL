...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 print:hidden">
        ...
        <div class="pl-10 sm:pl-0 flex flex-wrap items-center gap-2">
            <a href="{{ route('admin.laporan.export-excel', request()->query()) }}"
               class="inline-flex items-center justify-center px-3.5 py-2.5 text-xs font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100/80 border border-emerald-200/80 rounded-xl shadow-2xs transition">
            ...
            <a href="{{ route('admin.laporan.export-pdf', request()->query()) }}"
               class="inline-flex items-center justify-center px-3.5 py-2.5 text-xs font-semibold text-rose-700 bg-rose-50 hover:bg-rose-100/80 border border-rose-200/80 rounded-xl shadow-2xs transition">
            ...
            <button onclick="window.print()"
                    class="inline-flex items-center justify-center px-3.5 py-2.5 text-xs font-semibold text-slate-700 bg-white hover:bg-slate-50 border border-slate-200/90 rounded-xl shadow-2xs transition">
