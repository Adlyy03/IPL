...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-xl font-bold text-slate-900">Tambah Blok Baru</h1>
            <p class="text-xs text-slate-500 mt-0.5">Daftarkan blok dan nomor rumah pada gang perumahan.</p>
        </div>
    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
        <form action="{{ route('admin.blok.store') }}" method="POST" class="space-y-4">
            @csrf
